...
# this is the excellent diffgrad optimizer, added by @less.  It is only applicable for s4 and s5 (classification). 
# source credit: https://github.com/shivram1987/diffGrad
